...
\begin{DoxyItemize}
\item principal.\-cpp fichero donde se incluye el main del programa. En este caso, se toma como entrada el fichero de datos \char`\"{}crimenes.\-csv\char`\"{} y se debe cargar en el set.\end{DoxyItemize}

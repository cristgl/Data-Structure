...
@post Si esta en el conjunto su tamaÃ±o se decrementa en 1.
*/
...
// ================================= ITERADORES ========================================/
	...
	*/
	description_iterator dend( );
		/**   @brief devolver primera posicion del elemento que empareja con la descripcion descr
	@param[in] descr descripcion de buscamos
	@return un iterador constante que apunta a la primera posicion, el emparejamiento se hace teniendo en cuenta que descr debe ser una subcadena de la descripción del delito.
	*/
	...
	*/
	...
	/**@brief devuelve iterador constante al final (posición siguiente al último del conjunto)
     */
